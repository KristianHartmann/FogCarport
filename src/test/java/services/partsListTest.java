...
public class partsListTest {
    ...
    void setUp() {
        ...
        testPartsList.addToPartsListItemArrayList(new PartsListItem(new Part(30, "roofTop", "tagryg",
                400,"stk", 123), 0, "Til tagryg"));
        testPartsList.addToPartsListItemArrayList(new PartsListItem(new Part(31, "laths360Calc", "lægter 360",
                360,"stk", 123), 0, "lægter til skråtag"));
        testPartsList.addToPartsListItemArrayList(new PartsListItem(new Part(32, "laths480Calc", "lægter 480",
                480,"stk", 123), 0, "lægter til skråtag"));
        testPartsList.addToPartsListItemArrayList(new PartsListItem(new Part(33, "holePlate", "hulplade",
