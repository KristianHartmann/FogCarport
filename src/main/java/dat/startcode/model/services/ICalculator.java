...
public interface ICalculator {
    ...
    int looseHolter270(); // LØSHOLTER TIL GAVL
    int looseHolter240(); // LØSHOLTER TIL SIDER
    ...
    int roofPlates600Calc(); // TAGPLADE 600
    int roofPlates360Calc(); // TAGPLADE 360
    int roofBackCalc(); // TAGRYG TIL REJSNINGSTAG
    ...
    int universalBracketLeftCalc(); // UNIVERSALBESLAG VENSTRE
    int sternScrewsCalc(); // 4,5 x 60 SKRUER TIL STERN OG VANDBRÆT
    int bracketScrewsCalc(); // 4.0 x 50 BESLAGSKRUER TIL MONTERING AF UNIVERSAL + HULBÅND
